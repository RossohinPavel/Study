...
users = [{'name': 'Todd', 'phone': '551-1414', 'email': 'todd@gmail.com'},
         ...
         {'name': 'Fedor', 'phone': '+7445-341-0545', 'email': ''},
         {'name': 'Tim', 'phone': '242-449-3141', 'email': 'timm.ggg@yandex.ru'}]
print(*sorted([line['name'] for line in users if not 'email' in line or not line['email']]))
...
Sample Input 1: 230
Sample Output 1: two three zero
Sample Input 2: 7
...
Тестовые данные 🟢
Sample Input 1: CS101
Sample Output 1: CS101: 3004, Хайнс, 8:00
Sample Input 2: CM241
Sample Output 2: CM241: 1411, Ли, 13:00
"""
d = {"CS101": "3004, Хайнс, 8:00", "CS102": "4501, Альварадо, 9:00", "CS103": "6755, Рич, 10:00",
...
генерируется первый символ, указанный для этой клавиши. Нажатие цифры 2, 3, 42,3,4 или 55 раз генерирует второй, третий, 
...
Sample Output 1: 4433555555666110966677755531111
Sample Input 2: He said: "I can solve this problem".
Sample Output 2: 44330777724443111110444022226607777666555888330844444777707777666225553361
"""
d = {"1": ".,?!:", "2": "ABC", "3": "DEF", "4": "GHI", "5": "JKL", "6": "MNO", "7": "PQRS", "8": "TUV",
     "9": "WXYZ", "0": " "}
st = ''
for sym in input():
    x = sym.upper()
...
Sample Input 1: Interstellar
Sample Output 1: .. -. - . .-. ... - . .-.. .-.. .- .-.
Sample Input 2: SOS
Sample Output 2: ... --- ...
Sample Input 3: Agent 007
Sample Output 3: .- --. . -. - ----- ----- --...
"""
...
morse = ['.-', '-...', '-.-.', '-..', '.', '..-.', '--.', '....', '..', '.---', '-.-', '.-..', '--', '-.', '---',
         '.--.', '--.-', '.-.', '...', '-', '..-', '...-', '.--', '-..-', '-.--', '--..', '-----', '.----', '..---',
         '...--', '....-', '.....', '-....', '--...', '---..', '----.']
mc = dict(zip(letters, morse))
print(*[mc[x.upper()] for x in input() if x.upper() in mc])
